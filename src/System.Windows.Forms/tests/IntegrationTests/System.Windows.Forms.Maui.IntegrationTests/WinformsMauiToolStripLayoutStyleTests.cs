...
namespace System.Windows.Forms.Maui.IntegrationTests
{
    ...
    /// </summary>
    [Collection("Maui")]
    public class WinformsMauiToolStripLayoutStyleTests
    {
        private const string ProjectName = "MauiToolStripLayoutStyleTests";

        [Theory]
        [MauiData(ProjectName)]
        public void MauiToolStripLayoutStyleTests(string scenarioName)
        {
